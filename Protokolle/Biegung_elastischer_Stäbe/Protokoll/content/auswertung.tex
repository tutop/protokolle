...
Als Masse diente ein \SI{3.5527}{\kilo\gramm} schweres Gewicht. Für die Seite, die weiter vom Nullpunkt entfernt ist, ergibt
sich aus den in Tabelle \ref{tab:zweiwertel} gemessenen Werte
die Abbildung \ref{fig:kurveRechtlinks}. Hier wurde $D(x)$ über $f(x)=3L^2x-4x^3$ aufgetragen.
Durch lineare Ausgleichsrechnung ergibt sich für die linke Seite vom
